...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("atm_debug_sequential.log"),
...
# --------------------------------------------------------------------------
# Metro API Client (Sequential Version)
# --------------------------------------------------------------------------
class MetroAPI:
    """
    Fetches the "next tram" wait time from the ATM endpoint sequentially.
    """
    def __init__(self):
...
# --------------------------------------------------------------------------
# Trip Planner (Sequential Version)
# --------------------------------------------------------------------------
class TripPlanner:
    """
    TripPlanner that processes stations sequentially.
    """
...
# --------------------------------------------------------------------------
def main():
    logger.info("Starting ATM trip planner (Sequential Version)")
    start_time = time.time()
    ...
    print("\n=== Performance Metrics (Sequential Version) ===")
